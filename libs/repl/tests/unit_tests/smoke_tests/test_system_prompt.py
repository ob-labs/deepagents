...
def _capture_system_prompt(middleware: ReplMiddleware) -> str:
...
def test_system_prompt_snapshot_no_tools(
    ...
    prompt = _capture_system_prompt(ReplMiddleware())
    snapshot_path = snapshots_dir / "langchain_repl_system_prompt_no_tools.md"
...
def test_system_prompt_snapshot_with_mixed_foreign_functions(
    ...
    snapshot_path = (
        snapshots_dir / "langchain_repl_system_prompt_mixed_foreign_functions.md"
    )
    _assert_snapshot(snapshot_path, prompt, update_snapshots=update_snapshots)
